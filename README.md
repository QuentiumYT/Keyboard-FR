<h1 align="center" style="font-size: 50px;">Welcome to Keyboard-FR project 👋</h1>
...
**WINDOWS:** Simply click twice on `Keyboard-FR.pyw` or run using IDLE

**LINUX:** Not tested yet for GUIs
```bash
python3 Keyboard-FR.pyw
```
